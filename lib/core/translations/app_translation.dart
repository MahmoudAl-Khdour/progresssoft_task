...
class AppTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ar': {
          ...
          'Invalid password style': 'نمط كلمة المرور غير صالح',
          'Date of birth format error': 'خطا في شكل تاريخ الولاده',
          'Invalid confirm password style': 'نمط تأكيد كلمة المرور غير صالح',
          'Posts data is not available': 'بيانات المشاركات غير متوفرة',
          'Failed to load posts': 'فشل تحميل المشاركات:',
        },
        // English
        'en': {},
      };
